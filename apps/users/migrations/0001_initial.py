            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Валидна",
                    ),
                ),
                (
                    "expires_at",
                    models.DateTimeField(
                        help_text="Время истечения сессии", verbose_name="Истекает"
                    ),
                ),
                (
                    "user",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="telegram_se_user_id_799cf7_idx",
                    ),
                    models.Index(
                        fields=["expires_at"], name="telegram_se_expires_48318b_idx"
                    ),
                ],
            },
        ),
